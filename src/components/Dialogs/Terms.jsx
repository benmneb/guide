		...
		>
			...
			<DialogContent>
				<DialogContentText component="article" id="terms-of-use-description">
					...
					<Typography paragraph>are subject to the preceding paragraph; and</Typography>
					<Typography paragraph>
					...
					<Typography>ABN: 49 625 878 826</Typography>
					<Typography paragraph>Email: hello@vomad.guide</Typography>
