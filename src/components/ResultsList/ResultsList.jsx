				...
				<meta
					...
					content={
						!loadingInitially
							...
							: `There are thousands of vegan products in Australia. Browse all or apply up to 20 different filters to thousands of products to find the one you're looking for.`
					}
				/>
				<meta
					property="og:title"
					content={
						!loadingInitially
							? `Find Vegan ${categoryData.name} Products in Australia`
